  ...
  <div class="row">
	...
	<div class="col-lg-4 top">
		<div class="button-group-area mt-40">
			<a href="" class="genric-btn home e-large desc-m"><i class="fa fa-coffee fa-4x" aria-hidden="true"></i><br>{{$category->name}}</a>
		</div>
	</div>
	<div class="col-lg-4"></div>
  </div>
  <div class="row">
    @foreach ($sub_categories as $category)   
        <div class="col-lg-3 top">
            <div class="button-group-area mt-40">
                <a href="/{{$category->category_slug}}/{{$category->name}}/products" class="genric-btn home e-large desc-m"><i class="fa fa-coffee fa-large" aria-hidden="true"></i><br>{{$category->name}}</a>
            </div>
        </div>
        {{-- <div class="col-lg-2">
            <div class="button-group-area mt-40">
