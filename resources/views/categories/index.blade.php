...
<div class="site-main">
    ...
    <div class="container-fluid">
        <section class="jumbotron text-center">
            <div class="container">
                <h1 class="jumbotron-heading">PLEASE SELECT SUB CATEGORY</h1>
            </div>
        </section>
        <div class="row">
            ...
            <div class="col-lg-4 top">
                <div class="button-group-area mt-40">
                    <a href="" class="genric-btn home e-large desc-m"  style="pointer-events: none; cursor: default; color: #2E9AC8; background-color:white">
                        <img src="{{$category->img}}" alt="">
                        <br><h2 style="color: #2E9AC8;">{{$category->name}}</h2>
                    </a>
                </div>
            </div>
            <div class="col-lg-4"></div>
        ...
        <div class="row">
            @foreach ($sub_categories as $category)
                <div class="col-lg-3 top">
                    <div class="button-group-area mt-40">
                        <a href="/{{$category->category_slug}}/{{$category->name}}/products" class="genric-btn home e-large desc-m" style="color: #2E9AC8; background-color:white">
                            <i class="fa fa-coffee fa-large" aria-hidden="true"></i>
                            <br>{{$category->name}}
                        </a>
                    </div>
                </div>
