...
<div class="page-content edit-add container-fluid">
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="panel panel-bordered">
        ...
        value="{{$product->sub_category_slug}}" disabled>
    ...
    value="{{$product->alcohol_status}}" disabled>
  ...
  <div class="form-group col-md-12 " >
    ...
    value="{{$product->animal_additive_status}}" disabled>
  ...
  <div class="form-group col-md-12 " >
    ...
    value="{{$product->company_name}}" disabled>
  ...
  <div class="form-group col-md-12 " >
    ...
    value="{{$product->store_id}}" disabled>
